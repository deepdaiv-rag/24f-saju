...
from saju_rag.core.usecase.answer_with_external_info_usecase import AnswerWithExternalInfoUsecase
...
class BaseContainer(DeclarativeContainer):
    ...
    chat_gpt_client = providers.Resource(
        ChatGptClient,
    ...
    saju_web_api_repository = providers.Factory(
        ShinhanSajuWebApi,
        zenrows_client=zenrows_client,
        host=config.shinhan_saju_host
    )
